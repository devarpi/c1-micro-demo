...
import { PaginatedResultRoleRead, RoleCreate, RoleRead, RoleUpdate } from '../openapi';
...
export interface IRolesApi {
    ...
    list<T extends IPaginationExtended>(pagination?: T): Promise<ReturnPaginationType<T, PaginatedResultRoleRead, RoleRead[]>>;
    /**
