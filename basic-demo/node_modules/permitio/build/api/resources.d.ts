...
import { PaginatedResultResourceRead, ResourceCreate, ResourceRead, ResourceReplace, ResourceUpdate } from '../openapi';
import { BasePermitApi, IPaginationExtended, ReturnPaginationType } from './base';
export { ResourceCreate, ResourceRead, ResourceReplace, ResourceUpdate, PaginatedResultResourceRead, } from '../openapi';
export interface IResourcesApi {
    ...
    list<T extends IPaginationExtended>(pagination?: T): Promise<ReturnPaginationType<T, PaginatedResultResourceRead, ResourceRead[]>>;
    /**
