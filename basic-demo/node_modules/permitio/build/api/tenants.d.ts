 ...
 */
export declare class TenantsApi extends BaseFactsPermitAPI implements ITenantsApi {
    private tenants;
    /**
     ...
     * @throws {@link PermitContextError} If the configured {@link ApiContext} does not match the required endpoint context.
     */
    listTenantUsers({ tenantKey, ...params }: IListTenantUsers): Promise<PaginatedResultUserRead>;
    /**
     * Retrieves a tenant by its key.
     *
     * @param tenantKey The key of the tenant.
