...
import { RelationshipTupleCreate, RelationshipTupleCreateBulkOperation, RelationshipTupleDelete, RelationshipTupleDeleteBulkOperation, RelationshipTupleRead } from '../openapi';
import { BaseFactsPermitAPI, IPagination, IWaitForSync } from './base';
export { RelationshipTupleCreate, RelationshipTupleDelete, RelationshipTupleRead, RelationshipTupleCreateBulkOperation, RelationshipTupleDeleteBulkOperation, } from '../openapi';
/**
...
export interface IRelationshipTuplesApi extends IWaitForSync {
     ...
     * @throws {@link PermitContextError} If the configured {@link ApiContext} does not match the required endpoint context.
     */
    bulkRelationshipTuples(tuples: RelationshipTupleCreate[]): Promise<RelationshipTupleCreateBulkOperation>;
    /**
     ...
     * @throws {@link PermitContextError} If the configured {@link ApiContext} does not match the required endpoint context.
     */
    bulkUnRelationshipTuples(tuples: RelationshipTupleDelete[]): Promise<RelationshipTupleDeleteBulkOperation>;
}
/**
 * The RelationshipTuplesApi class provides methods for interacting with Role createments.
 */
export declare class RelationshipTuplesApi extends BaseFactsPermitAPI implements IRelationshipTuplesApi {
