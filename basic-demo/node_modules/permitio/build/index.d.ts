import { IPermitApi } from './api/api-client';
import { IPermitElementsApi } from './api/elements';
import { IPermitConfig } from './config';
import { IEnforcer } from './enforcement/enforcer';
import { ICheckQuery, IResource, IUser, IUserPermissions, TenantDetails } from './enforcement/interfaces';
 ...
 * ```
 */
export declare class Permit implements IPermitClient {
    private logger;
    private enforcer;
    /**
     * Access the SDK configuration using this property.
     ...
     * ```
     */
    readonly elements: IPermitElementsApi;
    /**
     ...
     */
    check(user: string | IUser, action: string, resource: string | IResource, context?: Context | undefined, config?: CheckConfig | undefined): Promise<boolean>;
    /**
     ...
     * @throws {@link PermitPDPStatusError} if received a response with unexpected status code from the PDP.
     */
    bulkCheck(checks: Array<ICheckQuery>, context?: Context | undefined, config?: CheckConfig | undefined): Promise<Array<boolean>>;
    /**
