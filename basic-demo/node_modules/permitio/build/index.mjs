...
var BaseAPI = class {
  constructor(configuration, basePath = BASE_PATH, axios4 = globalAxios) {
...
import globalAxios37 from "axios";
...
var BulkOperationsApiFp = function(configuration) {
  ...
  return {
    ...
    async bulkCreateTenants(projId, envId, requestBody, options) {
      ...
      return createRequestFunction(localVarAxiosArgs, globalAxios37, BASE_PATH, configuration);
    },
    /**
     *
     * @summary Bulk Create Users
...
// src/config.ts
import globalAxios38 from "axios";
...
var ConfigFactory = class _ConfigFactory {
  ...
  static defaults() {
    return {
      ...
      axiosInstance: globalAxios38.create(),
...
var Enforcer = class _Enforcer {
  ...
  constructor(config, logger) {
    this.config = config;
    this.logger = logger;
    const opaBaseUrl = new URL2(this.config.pdp);
...
export {
  ...
  ApiKeyLevel,
  AttributeType,
  ConditionSetRulesApi2 as ConditionSetRulesApi,
  ConditionSetType,
  ConditionSetsApi2 as ConditionSetsApi,
  DeprecatedApiClient,
  ElementsApiErrors,
  ElementsClient,
  ...
  ProjectsApi2 as ProjectsApi,
  ResourceActionGroupsApi2 as ResourceActionGroupsApi,
  ResourceActionsApi2 as ResourceActionsApi,
  ResourceAttributesApi2 as ResourceAttributesApi,
  ResourcesApi2 as ResourcesApi,
  RoleAssignmentsApi2 as RoleAssignmentsApi,
  RolesApi2 as RolesApi,
  TenantsApi2 as TenantsApi,
  UsersApi2 as UsersApi
};
