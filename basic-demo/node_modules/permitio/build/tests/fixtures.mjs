...
function handleApiError(error, message, t) {
  var _a, _b;
  const err = `${message}: status=${(_a = error.response) == null ? void 0 : _a.status}, url=${error.request.url}, method=${error.request.method}, details=${(_b = error.response) == null ? void 0 : _b.data}`;
