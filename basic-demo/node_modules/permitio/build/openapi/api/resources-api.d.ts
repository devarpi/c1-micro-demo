...
import { PaginatedResultResourceRead } from '../types';
...
export declare const ResourcesApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listResources: (projId: string, envId: string, includeBuiltIn?: boolean, page?: number, perPage?: number, includeTotalCount?: boolean, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const ResourcesApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listResources(projId: string, envId: string, includeBuiltIn?: boolean, page?: number, perPage?: number, includeTotalCount?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ResourceRead> | PaginatedResultResourceRead>>;
    /**
     * Completely replaces the resource definition.  - If the resource key is changed, all role and permissions assignments for the the resource will be revoked. - If the resource key is unchanged, but some actions are removed or renamed from the resource definition, role and permissions assignments for these actions will be revoked.  TODO: we need to decide if we are auto-revoking, or if we are rejecting the PUT completely while there are permissions that can be affected.
     * @summary Replace Resource
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare const ResourcesApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    listResources(projId: string, envId: string, includeBuiltIn?: boolean, page?: number, perPage?: number, includeTotalCount?: boolean, options?: any): AxiosPromise<Array<ResourceRead> | PaginatedResultResourceRead>;
    /**
     * Completely replaces the resource definition.  - If the resource key is changed, all role and permissions assignments for the the resource will be revoked. - If the resource key is unchanged, but some actions are removed or renamed from the resource definition, role and permissions assignments for these actions will be revoked.  TODO: we need to decide if we are auto-revoking, or if we are rejecting the PUT completely while there are permissions that can be affected.
     * @summary Replace Resource
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare class ResourcesApi extends BaseAPI {
     ...
     * @memberof ResourcesApi
     */
    listResources(requestParameters: ResourcesApiListResourcesRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<PaginatedResultResourceRead | ResourceRead[], any>>;
    /**
     * Completely replaces the resource definition.  - If the resource key is changed, all role and permissions assignments for the the resource will be revoked. - If the resource key is unchanged, but some actions are removed or renamed from the resource definition, role and permissions assignments for these actions will be revoked.  TODO: we need to decide if we are auto-revoking, or if we are rejecting the PUT completely while there are permissions that can be affected.
     * @summary Replace Resource
