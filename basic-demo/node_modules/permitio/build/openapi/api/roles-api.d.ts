...
export declare const RolesApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listRoles: (projId: string, envId: string, page?: number, perPage?: number, includeTotalCount?: boolean, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const RolesApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listRoles(projId: string, envId: string, page?: number, perPage?: number, includeTotalCount?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RoleRead> | PaginatedResultRoleRead>>;
    /**
     * This endpoint is part of the role hierarchy feature.  Removes `parent_role_id` from the list of parent roles of role with id `role_id`. In other words, `role_id` will no longer be automatically assigned permissions that are granted to `parent_role_id`.  We can say the `role_id` **not longer extends** `parent_role_id` or **no longer inherits** from `parent_role_id`.
     * @summary Remove Parent Role
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare const RolesApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    listRoles(projId: string, envId: string, page?: number, perPage?: number, options?: any): AxiosPromise<Array<RoleRead> | PaginatedResultRoleRead>;
    /**
     * This endpoint is part of the role hierarchy feature.  Removes `parent_role_id` from the list of parent roles of role with id `role_id`. In other words, `role_id` will no longer be automatically assigned permissions that are granted to `parent_role_id`.  We can say the `role_id` **not longer extends** `parent_role_id` or **no longer inherits** from `parent_role_id`.
     * @summary Remove Parent Role
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare class RolesApi extends BaseAPI {
     ...
     * @memberof RolesApi
     */
    listRoles(requestParameters: RolesApiListRolesRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<PaginatedResultRoleRead | RoleRead[], any>>;
    /**
     * This endpoint is part of the role hierarchy feature.  Removes `parent_role_id` from the list of parent roles of role with id `role_id`. In other words, `role_id` will no longer be automatically assigned permissions that are granted to `parent_role_id`.  We can say the `role_id` **not longer extends** `parent_role_id` or **no longer inherits** from `parent_role_id`.
     * @summary Remove Parent Role
